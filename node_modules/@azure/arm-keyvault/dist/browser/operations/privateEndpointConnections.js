...
export class PrivateEndpointConnectionsImpl {
    ...
    listByResourcePagingPage(resourceGroupName, vaultName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByResourcePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByResource(resourceGroupName, vaultName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByResourceNext(resourceGroupName, vaultName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByResourcePagingAll(resourceGroupName, vaultName, options) {
        return __asyncGenerator(this, arguments, function* listByResourcePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByResourcePagingPage(resourceGroupName, vaultName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, vaultName, privateEndpointConnectionName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, vaultName, privateEndpointConnectionName, options) {
