...
export class ManagedHsmKeysImpl {
    /**
    ...
    listVersionsPagingPage(resourceGroupName, name, keyName, options, settings) {
        return __asyncGenerator(this, arguments, function* listVersionsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listVersions(resourceGroupName, name, keyName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listVersionsNext(resourceGroupName, name, keyName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listVersionsPagingAll(resourceGroupName, name, keyName, options) {
        return __asyncGenerator(this, arguments, function* listVersionsPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listVersionsPagingPage(resourceGroupName, name, keyName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
