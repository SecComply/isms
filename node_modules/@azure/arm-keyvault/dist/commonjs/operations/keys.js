...
class KeysImpl {
    ...
    listVersionsPagingPage(resourceGroupName, vaultName, keyName, options, settings) {
        return tslib_1.__asyncGenerator(this, arguments, function* listVersionsPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield tslib_1.__await(this._listVersions(resourceGroupName, vaultName, keyName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
            ...
            while (continuationToken) {
                result = yield tslib_1.__await(this._listVersionsNext(resourceGroupName, vaultName, keyName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                (0, pagingHelper_js_1.setContinuationToken)(page, continuationToken);
                yield yield tslib_1.__await(page);
