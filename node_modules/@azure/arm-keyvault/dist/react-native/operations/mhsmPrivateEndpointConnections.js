...
export class MhsmPrivateEndpointConnectionsImpl {
    ...
    listByResourcePagingPage(resourceGroupName, name, options, settings) {
        return __asyncGenerator(this, arguments, function* listByResourcePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByResource(resourceGroupName, name, options));
    ...
    listByResourcePagingAll(resourceGroupName, name, options) {
        return __asyncGenerator(this, arguments, function* listByResourcePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByResourcePagingPage(resourceGroupName, name, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
     ...
     * @param options The options parameters.
     */
    async beginDelete(resourceGroupName, name, privateEndpointConnectionName, options) {
     ...
     * @param options The options parameters.
     */
    async beginDeleteAndWait(resourceGroupName, name, privateEndpointConnectionName, options) {
        const poller = await this.beginDelete(resourceGroupName, name, privateEndpointConnectionName, options);
